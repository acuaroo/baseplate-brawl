...
function CameraShakeInstance.new(magnitude, roughness, fadeInTime, fadeOutTime)
	...
	assert(type(magnitude) == "number", "[SCRSHAKE]: Magnitude must be a number")
	assert(type(roughness) == "number", "[SCRSHAKE]: Roughness must be a number")
	assert(type(fadeInTime) == "number", "[SCRSHAKE]: FadeInTime must be a number")
	assert(type(fadeOutTime) == "number", "[SCRSHAKE]: adeOutTime must be a number")
