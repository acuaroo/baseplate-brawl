...
Players.PlayerAdded:Connect(function(player)
	...
	function playerTrace:Changed()
		...
		elseif self.PrimaryState == "NONE" then
			local humanoid = player.Character:FindFirstChild("Humanoid")
			if not humanoid or self.MovementState == "RUNNING" then return end
	...
	function playerTrace:_restamina()
		if playerTrace._restam then return end
		local humanoid = player.Character:FindFirstChild("Humanoid")
		if not humanoid then return end
	...
	function playerTrace:Sprint() 
		if self.PrimaryState == "SLOW" then return end
		if self.PrimaryState == "STUN" then return end
		if self.PrimaryState == "GRAB" then return end
		if self.PrimaryState == "STUNLOCK" then return end

		local humanoid = player.Character:FindFirstChild("Humanoid")
		if not humanoid or self.MovementState == "WALKING" then return end
